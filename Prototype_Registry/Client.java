...
public class Client {
	private static void fillRegistry(StudentRegistry registry)
	{
		...
		//for that we will pass that object in the fillRegistry() method itself(StudentRegistry registry)
		registry.register("aug22", aug22);// key is "aug22" and value is aug22.
		//	this is how we have registered one register in the registry.
	...
	//First of all- to create the prototype we need to create the Student registry first.
		...
		fillRegistry(studentregistry);//defined above
